...
private slots:
  ...
  void downloadQsoComplete(bool result);
  void downloadQslComplete(bool result);
...
private:
  ...
  Q_SIGNAL void download_finished (bool) const;
...
private:
  ...
  bool    m_externalCtrl=false;   //avt
  QString m_checkCmd;             //avt
  bool    m_dblClk;               //avt
  QString m_dxCall;               //avt
  bool    m_bOffset;              //avt
  bool    m_txHaltClk;            //avt
  ...
  QSaveFile sav_file;
  bool url_valid;
  QUrl current_url;            // may be a redirect
  int redirect_count;
